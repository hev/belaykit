...
func main() {
	// Create a sample trace JSON matching belaykit's belay provider output format
	...
	// Also run belay without args to confirm SampleTree still works
